...
class _NotFoundScreenState extends State<NotFoundScreen> {
  ...
  Widget build(final BuildContext context) {
    ...
    final isNotFoundFromHome = observer.lastRoute?.settings.name == '/home';
    final isNotFoundFromNonLogin = FirebaseAuth.instance.currentUser == null;
            ...
            builder: (final context, final constraints) {
              ...
              return Column(
                children: <Widget>[
                  ...
                  // const Spacer(),
                  SvgPicture.asset(
                    'assets/splash_screens/404_screen$darkFilePrefix.svg',
                  ...
                  Text(
                    localized(context).error_404_title,
                  ...
                  Text(
                    localized(context).error_404_description,
                    textAlign: TextAlign.center,
                    style: titleMedium,
                  ),
                  SizedBox(
                  ...
                  FilledButton(
                    onPressed: () {
                      if (isNotFoundFromNonLogin) {
                        context.go('/splashscreen');
                      } else if (isNotFoundFromHome) {
